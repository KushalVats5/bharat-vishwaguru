...
{{-- @extends('site-layout') --}}
@section('content')
    <div class="content-box dynamic article video">
        <div class="row today-blog">
            <div class="col-md-12">
                <div class="what-new">
                    <h3>What's New in Media</h3>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="bottom-part">
                                <div class="left">
                                    ...
                                    <a href="#" class="like-count saveLikeDislike" data-type="like"
                                        data-post="{{ $article->id }}">
                                        <span class="" data-type="like" data-post="{{ $article->id }}"></span>
                                        ...
                                        <span class="likeDislike" data-type="dislike"
                                            data-post="{{ $article->id }}">{{ $article->likes() }}</span>
                                    </a>
                                    <a href="#" class="dislike-count saveLikeDislike" data-type="dislike"
                                        ...
                                        <span class="likeDislike" data-type="dislike"
                                            data-post="{{ $article->id }}">{{ $article->dislikes() }}</span>
                                    </a>
                                </div>
                                <div class="right">
                                    <a href="{{ $article->id }}" class="saveFavourite">
                                        <svg width="24" height="24" viewBox="0 0 29 29" fill="none"
                                            ...
                                            <line x1="14.5938" y1="7.34375" x2="14.5938" y2="21.6562"
                                                stroke="#CACEE5" stroke-width="2" stroke-linecap="round" />
                                            <line x1="21.6562" y1="14.5938" x2="7.34375" y2="14.5938"
                                                stroke="#CACEE5" stroke-width="2" stroke-linecap="round" />
                                        </svg>
                                    </a>
                                    <a href="#">
                                    ...
                                    <div class="content-box-right">
                                        ...
                                        <div class="user">
                                            ...
                                            <div class="user-name">
                                                ...
                                                <p>{{$view_count}} views • {{\App\Http\Helpers\Helper::timeAgo($article->created_at)}}</p>
                                            </div>
                                        </div>
                                        <div class="comment-box">
                                            <h5>{{ $commentsCounts }} Comments <a href="#">View Less</a></h5>
                                            <hr />
                                            @include('dynamic.commentsDisplay', [
