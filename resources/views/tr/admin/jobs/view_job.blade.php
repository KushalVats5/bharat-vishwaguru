                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('tr/admin/job/file', ['filename'=>$sale_bill]) }}"
                                            target="_blank">
                                            {{ $sale_bill }}
                                        </a>,&nbsp;
                                        @endforeach
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('tr/admin/job/file', ['filename'=>$purchase_bill]) }}"
                                            target="_blank">
                                            {{ $purchase_bill }}
                                        </a>,&nbsp;
                                        @endforeach
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('tr/admin/job/file', ['filename'=>$json_bill]) }}"
                                            target="_blank">
                                            {{ $json_bill }}
                                        </a>,&nbsp;
                                        @endforeach
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('tr/admin/job/file', ['filename'=>$job->jobable->gstr1_doc]) }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('tr/admin/job/file', ['filename'=>$job->jobable->gstr3b_doc]) }}"
                                            target="_blank">Download</a>
                                        @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('tr/admin/job/file', ['filename'=>$job->jobable->tax_computation_doc]) }}"
                                            target="_blank">Download</a>
                                        @else
                                ...
                                <tr>
                                    <td>Assign To</td>
                                    <td>
                                        <form action="" method="post" name="assign-to-update" id="assign-to-update">
                                            <div class="input-group mb-3">
                                                <select name="assign_to" id="assign_to" class="form-control select2">
                                                    <option value="">-Select-</option>
                                                    @foreach($freelancers as $freelancer)
                                                    <option value="{{$freelancer->id}}" @if( isset($job->assigned_to )
                                                        &&
                                                        ($job->assigned_to == $freelancer->id) ) selected @endif
                                                        >{{$freelancer->name}}</option>
                                                    @endforeach
                                                </select>
                                                <div class="input-group-append">
                                                    <button type="submit" class="btn btn-outline-primary btn-sm">
                                                        <i class="fas fa-save"></i> Click Here To Assign
                                                    </button>
                                                </div>
                                            </div>
                                            <div id="freelancer-info"></div>
                                        </form>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Status</td>
                                    <td>
                                        <form action="" method="post" name="status-update" id="status-update1">
                                            <div class="input-group mb-3">
                                                <select name="status" id="status" class="form-control select2" disabled>
                                                    ...
                                                    <option value="in progress" @if( isset($job->status) &&
                                                        ($job->status=='in
                                                        progress') ) selected @endif>In Progress</option>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-horizontal">
                                        ...
                                        <li class="list-group-item">
                                            <a href="{{ route('tr/admin/job/file', ['filename'=>$file]) }}"
                                                target="_blank">Download</a>
                                        </li>
                                        @endforeach
                                        @endif
