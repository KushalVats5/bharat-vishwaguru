            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <h5 class="page-title">Edit Testimonial </h5>
                    ...
                    <hr />
                    <form action="{{ route('testimonial.update', $page->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group ml-3 ">
                                <div class="author">
                                    ...
                                    @php
                                    $image = json_decode($page->featured_image);
                                    //dd($image);
                                    @endphp
                                    <a href="{{ route('dynamicArticle', $page->slug) }}" target="_blank" class="avatar border-gray">
                                        <img src="{{ $image->thumbnail }}" alt="blog thumb" width="150" height="">
                                    </a>
