...
@section('content')
			...
			<section id="about-area" class="cr-section about-area bg--white">
						...
						<div class="col-lg-10 offset-lg-1">
							<div class="about-area__content2 text-center">
								...
								<h3 class="cd-headline cx-heading slide">PROVIDE BEST TAX SOLUTION FOR YOUR
									...
									TO GROWUP</h3>
								<span class="text-left">{!!$content->content!!}</span>
								</a>
							</div>
						</div>
                ...
                <h3 class="text-justify ml-5">OUR ASSOCIATIONS</h3>
				<div class="col-lg-12">
					<div class="about-area__image2">
						<img src="{{asset('korde/images/bg/refrence.jpeg')}}" alt="about area image" width="100%">
					</div>
				</div>
			</section>
			<!-- //About Area -->
