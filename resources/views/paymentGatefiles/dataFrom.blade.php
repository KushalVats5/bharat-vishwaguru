...
<body >
	<form method="POST" name="customerData" action="{{route('ccavRequestHandler')}}" id="myForm" style="display: none">
    @csrf
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="50%" height="100" border='1' align="center">
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="34353"/></td>
				</tr>
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="{{rand()}}"/></td>
				</tr>
				<tr>
					@php
						$total_amt = \Cache::get('total_amt');
					@endphp
					<td>Amount	:</td><td><input type="text" name="amount" value="{{$total_amt}}"/></td>
				</tr>
				<tr>
					<td>Currency	:</td><td><input type="text" name="currency" value="INR"/></td>
				</tr>
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="{{route('paymentResponse')}}"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="{{route('paymentResponse')}}"/></td>
			 	</tr>
			 	<tr>
			...
			<tr> 
			 ...
			 <tr> 
		        ...
		        {{-- <tr>
		        	<td></td><td><a input type="submit" value="CheckOut">submit</td>
		        </tr> --}}
	      	</table>
