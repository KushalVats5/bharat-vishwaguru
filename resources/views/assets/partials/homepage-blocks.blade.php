        ...
        <div class="col-lg-4">
            <div class="feature">
                ...
                <div class="feature__content">
                    ...
                    <p class="wow fadeInUp text-justify" data-wow-delay="0.15s">Taxring's Information Security Client
                        Data Protection program equips client teams with a standardized approach and the security
                        controls and tools necessary to keep data safe.</p>
                </div>
            </div>
        </div>
        <!--// Single Feature -->
        ...
        <div class="col-lg-4">
            <div class="feature active">
                ...
                <div class="feature__content">
                    ...
                    <p class="wow fadeInUp text-justify" data-wow-delay="0.15s">Taxring has lots of Experienced Tax
                        experts/CA Professionals & Legal Consultants. We provide quick and friendly support to our
                        Clients in Pan India. </p>
                </div>
            </div>
        </div>
        <!--// Single Feature -->
        ...
        <div class="col-lg-4">
            <div class="feature">
                ...
                <div class="feature__content">
                    ...
                    <p class="wow fadeInUp text-justify" data-wow-delay="0.15s">Our experts/CA Professionals will be
                        available (Monday to Friday) from 10:00 AM to 7:00PM for Customer Query. Feel Free mail us
                        support@taxring.com </p>
                </div>
            </div>
        </div>
        <!--// Single Feature -->
        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 col-12">
                <div class="section-title">
                    ...
                    <p>Taxring provides excellence Taxation and Other Professional Services across in India.Find a
                        Package Suitable for you Below.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.15">
                                <div class="single-input">
                                    ...
                                    <select name="taxcalc_business_area" id="taxcalc_business_area">
                            ...
                            <div class="col-lg-6 col-md-6 wow fadeInUp">
                                ...
                                <div class="single-input">
                                    ...
                                    <select name="taxcalc_country_residence" id="taxcalc_country_residence">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-12 offset-0">
                <div class="section-title text-center">
                    ...
                    <p class="text-justify">Tax Advisors often prepare tax returns for clients, or they provide
                        information and advice to help clients fill out their own tax returns. They answer client
                        questions, help them prepare for future tax situations, and analyze information to ensure
                        compliance with government regulations. These professionals may check others’ work to detect
                        errors in tax preparation.</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="team-wrap">
                    ...
                    <div class="single-team">
                        ...
                        @endphp
                        <div class="image">
                            <img src="{{ $image->thumbnail }}" alt="Advisor Thumb" width="550" height="278">
                        </div>

                        @else

                        <div class="image">
                            <img src="{{ asset('korde/images/advisors/advisor-3/advisor-1.jpg') }}" alt="Advisor Thumb">
                        </div>
                        @endif
                        <div class="content">
                            <h6>{{ $item->name }}</h6>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="section-title no-padding">
                    ...
                    <p>Customer service means going above and beyond to keep the customer happy, whether that means
                        answering any questions they have or resolving issues with a positive attitude. Customer
                        satisfaction is the top priority, and hopefully creating loyal, returning customers.</p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-12 offset-0">
                <div class="section-title text-center">
                    ...
                    <p>Necessary Information will be published through our Experts. they shall share their own views and
                        information relating to Taxation, GST, Company Compliances, etc to the customers.</p>
                </div>
            </div>
        </div>
                ...
                <article class="blog sticky">
                    ...
                    <div class="blog__content">
                        <header class="blog__content__header">
                            ...
                            <h4>
                                <a href="{{ route('dynamicArticle', $item->slug) }}">{{ $item->title }}</a>
                            </h4>
                        </header>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1 col-md-12 offset-0">
                <div class="calltoaction text-center">
                    ...
                    <p> Our experts are always ready to help you. You can make an appointment with the CA/Tax Advisor to
                        resolve your Query. Experts shall be available in working business hours.
                    </p>
                    <h6>JUST DAIL
