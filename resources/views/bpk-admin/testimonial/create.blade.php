        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                {{-- <div class="">
                        ...
                        <div class="body">
                           <form id="form_validation" method="POST" action="{{ route('testimonial.store') }}"
            ...
            <div class="d-flex justify-content-between">
                <h5 class="page-title">Testimonial <small>( {{__('All page goes here')}} ) </small></h5>
                <div class="heading-elements">
                    <a class="btn btn-danger btn-sm px-5" href="{{route('testimonial.index') }}">
