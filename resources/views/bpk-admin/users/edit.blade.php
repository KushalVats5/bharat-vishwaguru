                           ...
                           <form id="form_validation" method="POST" action="{{ route('users.update',$user->id) }}">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select id="your-select" class="form-control @error('roles') is-invalid @enderror" name="is_active" required>
                                        <option value="0" {{($user->is_active == 0) ? 'selected' : ''}}>In Active</option>
                                        <option value="1"{{($user->is_active == 1) ? 'selected' : ''}}>Active</option>
                                    </select>
                                    @error('is_active')
                                        <label id="is_active-error" class="error" for="is_active">{{ $message }}</label>
                                    @enderror
                                </div>
