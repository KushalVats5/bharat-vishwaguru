    ...
    public function store(Request $request)
    {
        ...
        try {
            if (auth()->user()->can('create pages')) {
                ...
                $page->save();
                return redirect()->route('pages.index')->with('success', "The $page->title was saved successfully");
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            if (auth()->user()->can('edit pages')) {
                ...
                return redirect()->route('pages.index')->with('warning', "The $page->title was updated successfully");
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            if (auth()->user()->can('delete pages')) {
                ...
                return redirect()->route('pages.index')->with('danger', "The $page->title was deleted successfully");
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
