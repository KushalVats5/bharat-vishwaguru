...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (auth()->user()->can('create articles')) {
                ...
                return redirect()->route('services.index')->with('success', "The $request->title was saved successfully");
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
    ...
    public function show($id)
    {
        ...
        return view('admin.services.show', ['article' => $article]);
    }
    ...
    public function edit($id)
    {
        try {
            if (auth()->user()->can('edit articles')) {
                ...
                $categories = Category::all();
                return view('admin.services.edit', compact('article', 'categories'));
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            if (auth()->user()->can('edit articles')) {
                ...
                return redirect()->route('services.index')->with('warning', "The $request->title was updated successfully");
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            if (auth()->user()->can('delete articles')) {
                ...
                return redirect()->route('services.index')->with('danger', "The $service->title was deleted successfully");
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
