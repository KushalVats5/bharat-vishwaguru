    ...
    public function index()
    {
        try {
            if (auth()->user()->can('list users')) {
                ...
                return view('tr.admin.roles.index', compact('roles'));
            } else {
    ...
    public function create()
    {
        try {
            if (auth()->user()->can('create roles')) {
                ...
                return view('tr.admin.roles.create', compact('permissions'));
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
    ...
    public function store(Request $request)
    {
        try {
            if (auth()->user()->can('create roles')) {
                ...
                return redirect()->route('role.index')->with('success', "The $role->name was saved successfully");
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        try {
            if (auth()->user()->can('edit roles')) {
                ...
                return view('tr.admin.roles.edit', compact('role', 'permissions', 'selectedPermissions'));
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            if (auth()->user()->can('delete roles')) {
                ...
                return redirect()->route('role.index')->with('danger', "The $role->name was deleted successfully");
            } else {
                throw new Exception('You don\'t have a rights to perform this action');
            }
        } catch (\Exception $e) {
